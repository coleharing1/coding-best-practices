---
description: Prepare a PLAN.md handoff for Codex execution
argument-hint: [phase-number]
---

## Codex Handoff — Phase $ARGUMENTS

Read `PLAN.md` and extract Phase $ARGUMENTS.
...
4. **Acceptance criteria** — copy from PLAN.md, must be binary pass/fail
